...
use crate::config::{Config, GraderConfig, ProbeConfig};
...
impl AppState {
    pub fn new(config: &Config, eval_tx: tokio::sync::mpsc::UnboundedSender<TurnRecord>, grader_config: GraderConfig, probe_config: ProbeConfig) -> Self {
